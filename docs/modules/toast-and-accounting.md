...
3. Normalize menu, group, item, category, SKU, PLU, description, primary HTTPS image reference, price, visibility, and active state without storing order or customer identity or copying image bytes into Postgres.
