...
tags: [pipeline, google-drive, google-sheets, outbox, provisioning, projections]
app_visible: true
---
...
- A managed Sheet contains exactly `Opportunities`, `Organizations`, `Contacts`, `Interactions`, and `Dropdowns`; headers begin at `B4`.
