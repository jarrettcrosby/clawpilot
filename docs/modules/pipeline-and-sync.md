...
- ClawPilot opportunity creation requires a caller-stable idempotency key. A network retry therefore returns the same CRM opportunity instead of creating a duplicate.
