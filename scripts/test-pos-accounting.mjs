...
for (const fragment of [
  ...
  'currentMappingsForScope(workspace, selectedScope)',
  'Array.isArray(mappingScopes.organizationDefault)',
  ...
  'mapping.targetId && (mapping.active || !mappingIsDirty)',
  'Showing organization-default profile and mappings.',
  'saved to ${scope === \'organization_default\' ? \'the organization default\' : \'this location override\'} as a new revision.',
  '.map(mappingPayload)',
