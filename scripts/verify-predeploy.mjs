...
for (const requiredPath of [
  ...
  'db/migrations/0329_career_site_submissions.sql',
  'db/migrations/0330_career_site_mail_outbox.sql',
  'app_src/lib/careerSiteSubmissionContract.ts',
  'app_src/lib/persistence/careerSiteSubmissions.ts',
  'app_src/lib/careerSiteSubmissionOutbox.ts',
  'app_src/lib/careerSiteMailContract.ts',
  'app_src/lib/careerSiteMailCrypto.ts',
  'app_src/lib/careerSiteMailDelivery.ts',
  'app_src/lib/persistence/careerSiteMailOutbox.ts',
  'app_src/lib/careerSiteMailOutbox.ts',
  'app_src/app/api/career-site/submissions/route.ts',
  'app_src/app/api/career-site/submissions/requeue/route.ts',
  'app_src/app/api/career-site/mail/route.ts',
  'app_src/app/api/career-site/mail/requeue/route.ts',
  'app_src/app/api/career-site/submissions/outbox/process/route.ts',
  'app_src/app/api/persistence/status/route.ts',
  'app_src/tests/integrations/career-site-submission-contract.test.ts',
  'app_src/tests/integrations/career-site-mail-contract.test.ts',
  'scripts/test-career-site-submissions.mjs',
  'scripts/test-career-site-shortlink-auth.mjs',
  'scripts/test-career-site-submission-worker-recovery.mjs',
  'scripts/test-career-site-worker-route.mjs',
  'scripts/test-career-site-mail.mjs',
  'scripts/test-career-site-mail-crypto.mjs',
