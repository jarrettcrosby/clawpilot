...
assert.match(source.fixture, /body\?\.action === 'quote'/)
assert.match(source.fixture, /quote: localFixtureQuote\(body\.quote as OneOffShipmentQuoteInput\)/)
assert.match(source.fixture, /body\?\.action === 'create-and-plan'/)
assert.match(source.fixture, /result: localFixtureCreateResult\(body\.selectedOfferGlobalId\)/)
assert.match(source.fixture, /carrierRateReads: 0/)
assert.match(source.fixture, /postagePurchases: 0/)
