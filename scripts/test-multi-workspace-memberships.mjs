...
assertIncludes(switcher, 'Open demo workspace', 'authenticated demo workspace entry')
assertIncludes(switcher, "fetch('/api/workspaces/demo-entry'", 'authenticated demo availability check')
