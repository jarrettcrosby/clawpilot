...
assertIncludes(switcher, 'Open demo account', 'authenticated demo account entry')
assertIncludes(switcher, "fetch('/api/workspaces/demo-entry', { method: 'POST' })", 'authenticated demo account switch')
