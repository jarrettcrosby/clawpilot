...
assertIncludes(crmAdapter, 'DO NOTHING\n      RETURNING idempotency_key', 'idempotent SuiteCRM outbox insertion result')
...
assertIncludes(opportunityRoute, "entity: 'opportunities'", 'CRM opportunity writeback')
