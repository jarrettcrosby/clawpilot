...
assert.match(panel, /Shopify · configured history window · read only/)
assert.match(panel, /Faire · configured history window · read only/)
assert.match(panel, /new orders after connection/)
assert.match(panel, /prior 60 days/)
assert.match(panel, /all provider-available history/)
...
assert.match(panel, /did not attest the oldest window edge/)
