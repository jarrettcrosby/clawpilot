...
assert.match(persistence, /COMMERCE_AUTHORITY_STORE_SYNC_PAUSED/)
assert.match(persistence, /operations_commerce_store_sync_is_running/)
assert.match(persistence, /store_sync_effective_reason/)
