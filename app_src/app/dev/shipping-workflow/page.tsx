...
import ShippingWorkflowDevelopmentFixture from '@/components/shipping/ShippingWorkflowDevelopmentFixture'

export const dynamic = 'force-dynamic'

export default function ShippingWorkflowDevelopmentPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', padding: '24px', background: '#101016' }}>
      <ShippingWorkflowDevelopmentFixture />
    </main>
  )
}
