...
export default function HomeClient() {
  ...
  // Sync section from URL hash on mount — client-only, after hydration
  useEffect(() => {
    setHydrated(true)
    ...
    const onHashChange = () => setActiveSectionState(getSectionFromHash())
  ...
  // Don't render hash-dependent content until client-side hydration is complete
  const section = hydrated ? activeSection : 'dashboard'
