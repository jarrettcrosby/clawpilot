  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([taskData, threadData]) => {
        ...
        if (Array.isArray(threadData)) setThreadRows(threadData as ThreadRow[])
        else if (Array.isArray((threadData as ThreadsPayload)?.threads)) setThreadRows((threadData as ThreadsPayload).threads || [])
        else setThreadRows([])
      })
      .catch(() => {
