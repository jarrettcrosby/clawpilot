...
test('picker audio routing and Meta scan feedback stay explicit and bounded', () => {
  ...
  assert.match(voice, /\.cachesDirectory[\s\S]*"models"[\s\S]*"aufklarer"[\s\S]*"Supertonic-3-CoreML-FP16"/)
  ...
  assert.match(voice, /The retired voice pack could not be removed/)
