...
const GLOBAL_IDS = {
  organization: /^ga[0-9]{7}$/u,
  activeExecution: /^gaex[0-9]{7}$/u,
  activeShipmentGroup: /^gash[0-9]{7}$/u,
  order: /^gor[0-9]{7}$/u,
  plan: /^gfp[0-9]{7}$/u,
  warehouse: /^gwh[0-9]{7}$/u,
  package: /^gpa[0-9]{7}$/u,
  integrationAccount: /^gia[0-9]{7}$/u,
  carrierAccount: /^gac[0-9]{7}$/u,
  run: /^gafr[0-9]{7}$/u,
  attempt: /^gara[0-9]{7}$/u,
  result: /^garr[0-9]{7}$/u,
  offer: /^garo[0-9]{7}$/u,
  selection: /^gars[0-9]{7}$/u,
} as const
