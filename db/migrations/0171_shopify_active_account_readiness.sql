-- A disabled commerce account is not eligible for checkout callbacks,
-- automatic inventory refresh, or any other CarrierService-ready projection.
-- Replace the readiness function introduced by migration 0165 without
-- rewriting that already-applied migration.
...
COMMENT ON FUNCTION
  ...
  'Returns true only when the active sandbox Shopify commerce account, provider-verified bounded store entity, activation, warehouse, current packaging stock, and paired verified UPS/FedEx bindings are ready.';
